...
export const FAQS = [
  ...
  { q: "Como chegar à Faculdade Dom Bosco?", a: `A Faculdade Dom Bosco fica na R. Mal. José Inácio da Silva, 355 - Passo d'Areia, Porto Alegre/RS. Há estacionamento particular ao lado, no Colégio Dom Bosco. Veja mapa e como chegar em <a href="/experiencia">Experiência</a>.` },
  ...
  { q: "A programação já está disponível?", a: `Sim! A grade completa já está no ar, com 37 conteúdos entre palestras, workshops, mentorias, laboratórios e rodas de conversa, mais de 40 pessoas palestrantes, organizados em 6 trilhas por assunto — IA e agentes, arquitetura, segurança, mobile, dados, carreira e mais. Veja tudo, por trilha ou por horário, em <a href="/programacao">nossa página de Programação</a>.` },
  ...
  { q: "Terá alimentação?", a: `Sim! Credenciamento com Welcome Coffee pela manhã (8h15–9h) e coffee break à tarde estão inclusos em todos os tipos de ingresso. Para o almoço, indicamos a Cantina Gabigu, dentro da própria Faculdade Dom Bosco, com opções de buffet e lanches. Veja mais em <a href="/experiencia">Experiência</a>.` },
...
export const EXPLORE_CARDS = [
  {
    ...
    text: "Conheça a proposta do DevFestPoa26, os pilares de conteúdo e as 6 trilhas da programação.",
    tag: "Comece por aqui",
    color: "#ff7a29",
  },
  {
    ...
    icon: "🎯",
    title: "Tema 2026",
    text: "Criar, proteger, escalonar: desenvolvedores e criadores na era agêntica.",
    tag: "Conteúdo",
    color: "#9784ff",
  },
  {
    ...
    icon: "🗓️",
    title: "Programação",
    text: "38 conteúdos entre palestras, workshops e mentorias, por trilha e por horário.",
    tag: "Grade oficial",
    color: "#ff6a88",
  },
  {
    ...
    icon: "🧭",
    title: "Experiência",
    text: "Guia prático, networking na Sala Covil, DevFestPoaGAME e a edição anterior.",
  ...
  },
  {
    ...
    text: "Empresas que acreditam e apoiam o ecossistema de tecnologia.",
    tag: "Quem apoia",
    color: "#5be08a",
  },
  {
    ...
    icon: "❓",
    title: "FAQ",
    text: "Tire suas dúvidas sobre o evento, ingressos e acessibilidade.",
    tag: "Dúvidas",
    color: "#f6cf4d",
  },
];
